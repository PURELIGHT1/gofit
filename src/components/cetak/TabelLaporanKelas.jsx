...
import { useExportKelas } from '../table/hooks/queries'

const TabelLaporanKelas = forwardRef(({ year, month, cetak }, ref) => {
    const { data } = useExportKelas(month, year);
  ...
  return (
    ...
    <div className="mx-8" ref={ref}>
        ...
        <div className="mt-4">
          <h2 className="text-lg font-semibold underline">LAPORAN AKTIVITAS KELAS BULANAN</h2>
...
export default TabelLaporanKelas
