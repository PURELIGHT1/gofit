...
import { useAktifInstrukturs } from '../hooks/queries'

const ConfirmationModalHapus = ({ id, type, nama }) => {
    console.log(id);

    const { mutate, isLoading } = useAktifInstrukturs();
                                ...
                                <div className="sm:flex sm:items-start">
                                    ...
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        <h3
                                            ...
                                            id="modal-title"
                                        >
                                        { type === 'hapus'? 'Hapus Instruktur' : 'Aktif Instruktur'}{' '}
                                        </h3>
                                        <div className="mt-2">
...
export default ConfirmationModalHapus;
