...
import { useDepositKelas } from './hooks/queries'
import Table, { SelectColumnFilter } from '../../../../components/table/Table'
import ModalTambah from '../aktivasi/actions/ModalTambah'
import ModalTambahDepoKelas from './components/ModalTambahDepoKelas'

const DepositKelasPage = () => {
  const { data, isLoading } = useDepositKelas();
  ...
  const columns = useMemo(() => {
        return [
            ...
            },
            {
                ...
                accessor: 'sisaKelas',
                Cell: ({ row }) => {
                  const kelas = row.original.sisaKelas;
                  return (
                      <span>
                        {kelas}
                      </span>
    ...
    <>
      <ModalContainer />
        <div className="flex items-center justify-between mb-4">
          <h1 className="font-bold text-xl">List Deposit Kelas</h1>
...
export default DepositKelasPage
