...
import { useAktifMember} from '../hooks/queries'

const ConfirmationModalAktivasi = ({ id, type, nama }) => {
    console.log(id);

    const { mutate, isLoading } = useAktifMember();
...
export default ConfirmationModalAktivasi;
