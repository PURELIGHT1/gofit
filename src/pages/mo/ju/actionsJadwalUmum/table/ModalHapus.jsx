...
import { useDeleteJadwal } from '../../hooks/queries'

const ModalHapus = ({ id, hari ,kelas ,ins, type}) => {
    console.log(id);

    const { mutate, isLoading } = useDeleteJadwal();
                                        ...
                                        <div className="mt-2">
                                            <p className="text-base text-gray-600">
                                                ...
                                                {type === 'hapus'
                                                    ? 'menghapus'
                                                    : 'aktifkan'}{' '}
                                                jadwal pada hari <strong>{hari}</strong>, dengan kelas <strong>{kelas}</strong>, dengan instruktur <strong>{ins}</strong>?
                                            </p>
                                        </div>
                                    </div>
                                </div>
