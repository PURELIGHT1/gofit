...
import BarChartKelas from '../../../../components/table/BarChartKelas'
import TabelLaporanKelas from '../../../../components/cetak/TabelLaporanKelas'
    ...
    <>
      <div className="mx-8">
        ...
        <div className="flex items-center justify-between mt-4 mb-2">
          <h1 className="text-xl font-bold">Grafik Aktivitas Kelas Bulanan</h1>
          ...
          <div className="px-8 py-8 bg-white shadow-sm border-[1px]">
            <BarChartKelas year={year} month={month} />
          </div>
          <div className="mt-10 mb-2">
            <h1 className="text-xl font-semibold">Tabel Aktivitas Kelas Bulanan</h1>
          </div>
        </div>
