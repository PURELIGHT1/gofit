...
import BarChartGym from '../../../../components/table/BarChartGym'
import TabelLaporanGym from '../../../../components/cetak/TabelLaporanGym'

const LaporanGymPage = () => {
   ...
   <>
      <div className="mx-8">
        ...
        <div className="flex items-center justify-between mt-4 mb-2">
          <h1 className="text-xl font-bold">Grafik Aktivitas Gym Bulanan</h1>
        ...
        <div className="px-8 py-8 bg-white shadow-sm border-[1px]">
          <BarChartGym year={year} month={month} />
        </div>
        <div className="mt-10 mb-2">
          <h1 className="text-xl font-semibold">Tabel Aktivitas Gym Bulanan</h1>
        </div>
      </div>
